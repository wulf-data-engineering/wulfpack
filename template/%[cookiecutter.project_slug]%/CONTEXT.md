...
1. Consult `.agent/change_protocols.md` how to add/change the protocols.
2. Consult `.agent/change_backend.md` how to make changes to the backend & cloud resources.
3. Consult `.agent/change_frontend.md` how to make changes to the frontend.
4. Consult `.agent/try_browser.md` how to try the changes in the browser.
5. Consult `.agent/test_e2e.md` how to run the end-to-end tests
